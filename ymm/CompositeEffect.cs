...
internal sealed class CompositeEffect(IGraphicsDevicesAndContext devices) : D2D1CustomShaderEffectBase(Create<CompositeEffect.Impl>(devices))
{
    ...
    public float HueShift { set => SetValue(5, value); }
    public float Vibrance { set => SetValue(6, value); }
    ...
    private sealed class Impl : D2D1CustomShaderEffectImplBase<Impl>
    {
        ...
        [CustomEffectProperty(PropertyType.Float, 0)] public float Amount { get => _constants.Amount; set { _constants.Amount = Math.Clamp(value, -1f, 4f); UpdateConstants(); } }
        ...
        [CustomEffectProperty(PropertyType.Float, 5)] public float HueShift { get => _constants.HueShift; set { _constants.HueShift = Math.Clamp(value, -180f, 180f); UpdateConstants(); } }
        [CustomEffectProperty(PropertyType.Float, 6)] public float Vibrance { get => _constants.Vibrance; set { _constants.Vibrance = Math.Clamp(value, 0f, 1f); UpdateConstants(); } }
        ...
        private struct Constants
        {
            ...
            public float Brightness, HueShift, Vibrance, Padding;
        }
    }
}
